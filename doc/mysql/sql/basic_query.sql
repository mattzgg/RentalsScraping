...
call get_scraping_request_statistics('04/11/2020', @total_count, @processed_count);
select @total_count, @processed_count;

select * from rental_route order by id;
call get_pending_scraping_requests('03/11/2020', 1000, 1000);
