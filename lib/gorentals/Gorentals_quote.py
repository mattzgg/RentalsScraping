...
driver.get("https://www.gorentals.co.nz/")
...
driver.find_element_by_css_selector('#__layout > div > div.flex-1-0-auto > main > header > content > div.position-absolute.top.left.width-span12.height-span12.tablet\:paddingRight-48.desktop\:paddingRight-56 > div > div.flex-1.display-flex.flexDirection-column.justifyContent-flexEnd.paddingTop-16.paddingBottom-16.tablet\:justifyContent-center.tablet\:paddingBottom-8.tabletWide\:paddingBottom-32 > div > div > form > div.gridColumn-span12.tabletWide\:gridColumn-span4.justifySelf-flexEnd.tabletWide\:justifySelf-center.tabletWide\:alignSelf-center > button').click()
...
car_categories = []
car_category_name_1 = driver.find_element_by_css_selector('#__layout > div > div.flex-1-0-auto > main > content > section > content > div:nth-child(1) > h2').text
car_categories.append(car_category_name_1)
car_category_name_2 = driver.find_element_by_css_selector('#__layout > div > div.flex-1-0-auto > main > content > section > content > div:nth-child(2) > h2').text
car_categories.append(car_category_name_2)
car_category_name_3 = driver.find_element_by_css_selector('#__layout > div > div.flex-1-0-auto > main > content > section > content > div:nth-child(3) > h2').text
car_categories.append(car_category_name_3)
car_category_name_4 = driver.find_element_by_css_selector('#__layout > div > div.flex-1-0-auto > main > content > section > content > div:nth-child(4) > h2').text
car_categories.append(car_category_name_4)
car_category_name_5 = driver.find_element_by_css_selector('#__layout > div > div.flex-1-0-auto > main > content > section > content > div:nth-child(5) > h2').text
car_categories.append(car_category_name_5)
...
# Get car years
car_years_list = []
for car_years in driver.find_elements_by_css_selector('[class="fontSize-14 color-goGrayDark"'):
...
# Get total price
total_price_list = []
for total_price in driver.find_elements_by_css_selector('[class="display-inlineBlock lineHeight-20"'):
...
status_list = []
for status in driver.find_elements_by_css_selector('[class="paddingLeft-8 paddingRight-8"'):
    result = status.text
